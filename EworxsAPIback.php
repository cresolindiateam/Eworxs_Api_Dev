...
// echo $resultsubscription->num_rows;
...
$apiKey = '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';
$toEmail = $email;
...
// $smtpHost = 'localhost';
// $smtpPort = 25; // GoDaddy's SMTP server uses SSL, so use port 465
// $username = 'ajaysoni9039@gmail.com'; // Your GoDaddy email address
// $password = '9039145741'; // Your GoDaddy email password
...
//     $mail->Port = $smtpPort;
//     $mail->setFrom('gdhosting@eworxs.app');
//     $mail->addAddress('ajay@cresol.in');
//     // $imageURL = $fileName1;
//     // $mail->AddStringEmbeddedImage(file_get_contents($imageURL), 'embedded_image', 'img.png', 'base64', 'image/png', 'inline');
//     $mail->isHTML(true);
//      $mail->Body = 'here is your pdf file';
//     $pdfFilePath = 'https://eworxs.app/EworxsApi/pdfs/'.$fileName; 
//     $pdfData = file_get_contents($pdfFilePath);
//     $mail->addStringAttachment($pdfData, 'invoice.pdf');
//     $mail->Subject = 'Eworxs Invoice';
//     $mail->send();
